...
public class DigitalBookServiceTest {
    ...
    public void getAllBookDetailsTest() {
        ...
        List<Book> bookList = new ArrayList<>();
        bookList.add(book);
        Mockito.when(digitalBookRepository.findBooks()).thenReturn(bookList);
        List<BookResponse> responses = digitalBookService.getAllBookDetails();
        Assert.assertNotNull(responses);
    }

    @Test
    public void getAllBookDetailByIdTest() {
        User user = new User();
        user.setId(123);
        user.setRoles(null);
        user.setEmail("abc");
        ...
        List<Book> bookList = new ArrayList<>();
        bookList.add(book);
        Mockito.when(digitalBookRepository.findByUserUserId(123)).thenReturn(bookList);
        List<BookResponse> responses = digitalBookService.getAllBookDetails(123);
        Assert.assertNotNull(responses);
    }
}